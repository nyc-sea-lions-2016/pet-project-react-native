...
var REQUEST_URL = process.env.NODE_ENV == "development" ? 'http://localhost:3000/index.json' : 'https://nextbestfriend.herokuapp.com/index.json';

var REQUEST_ONE_URL = process.env.NODE_ENV == "development" ? 'http://localhost:3000/one.json' : 'https://nextbestfriend.herokuapp.com/one.json';

var FAVORITE_URL = process.env.NODE_ENV == "development" ? 'http://localhost:3000/pets.json' : 'https://nextbestfriend.herokuapp.com/pets.json';

var PET_URL = process.env.NODE_ENV == "development" ? 'http://localhost:3000/pets/1.json' : 'https://nextbestfriend.herokuapp.com/pets/1.json';
